...
public class VoidStarlightRenderer extends TileEntitySpecialRenderer<TileEntityVoidStarlight> {
    ...
    public void render(@NotNull TileEntityVoidStarlight te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        IExtendedBlockState fluidState = (IExtendedBlockState) block.getExtendedState(te.getWorld().getBlockState(te.getPos()),
