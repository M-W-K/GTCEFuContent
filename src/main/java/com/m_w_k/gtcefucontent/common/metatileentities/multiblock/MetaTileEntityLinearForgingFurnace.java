...
import com.m_w_k.gtcefucontent.api.capability.impl.GTCEFuCHeatingCoilRecipeLogic;
import com.m_w_k.gtcefucontent.api.metatileentity.GTCEFuCMultiShapeMultiblockController;
...
public class MetaTileEntityLinearForgingFurnace extends GTCEFuCMultiShapeMultiblockController implements IHeatingCoil {
    ...
    public MetaTileEntityLinearForgingFurnace(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTCEFuCRecipeMaps.LINEAR_FORGING_RECIPES);
        this.recipeMapWorkable = new GTCEFuCHeatingCoilRecipeLogic(this);
    }
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .where('U',
                        () -> ConfigHolder.machines.enableMaintenance ? MetaTileEntities.MAINTENANCE_HATCH :
                                getCasingState(),
                        EnumFacing.SOUTH);
        MetaTileEntityLinearForgingFurnace fakeController = (MetaTileEntityLinearForgingFurnace) GTCEFuCMetaTileEntities.FORGING_FURNACE
        ...
        doRowCopies(shapeInfo, builder,
                a -> a.where('S', fakeController, EnumFacing.SOUTH)
                        .aisle("            XXXX    ", "            XXXX    ", "            XXXX    ",
                                "                    ", "                    ", "XXX EFCFFCFE HHH XXX",
                                "XMX EICVVCIE HHH XXX", "XXX EFCFFCFE HHH XXX", "             BVB    ",
                                "             BBB    "),
                (a, i, j) -> {
                    if (j == 0 || j == i - 1) {
                        a.aisle("            XDDX    ", "            XGGF    ", "            XIPX    ",
                                "              P     ", "              P     ", "XXX ECCCCCCE HPH XXX",
                                "XPPPP######PPP#PPPPX", "XXX ECCCCCCE HPH XXX", "             VPV    ",
                                "             BVB    ");
                    } else {
                        a.aisle("            XDDX    ", "            XGGF    ", "            XIXX    ",
                                "                    ", "                    ", "XXX ECCCCCCE HHH XXX",
                                "XPPPP######PPP#PPPPX", "XXX ECCCCCCE HPH XXX", "             VPV    ",
                                "             BVB    ");
                    }
                },
                a -> a.aisle("            XXXX    ", "            XXXX    ", "            XXXX    ",
                        "                    ", "                    ", "XXX EFCFFCFE HHH XXX", "YSX EICVVCIE HHH ULX",
                        "ZXN EFCFFCFE HHH OXT", "             BVB    ", "             BBB    "));
    ...
    private static IBlockState getCasingState() {
        return GTCEFuCMetaBlocks.STANDARD_CASING
                .getState(GTCEFuCBlockStandardCasing.CasingType.FORGING_CASING);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @NotNull List<String> tooltip,
                               boolean advanced) {
        tooltip.add(I18n.format("gtcefucontent.machine.linear_forging_furnace.tooltip.1"));
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return GTCEFuCTextures.FORGING_CASING;
    }
