...
public class GTCEFuCEutecticLoader {
    ...
    public static void init() {
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(
                        EutecticCaesiumSodiumPotassium.getProperty(GTCEFuCPropertyKey.THREE_TEMP_FLUID)
                                .getFluidCold(1000),
        ...
        for (Material eutectic : EutecticAlloys.keySet()) {
            ...
            RecipeMaps.FLUID_HEATER_RECIPES.recipeBuilder()
                    ...
                    .duration((int) (10L * property.getThermalCapacity() * heatDiff /
            ...
            RecipeMaps.VACUUM_RECIPES.recipeBuilder()
                    ...
                    .duration((int) (100L * property.getThermalCapacity() * heatDiff /
