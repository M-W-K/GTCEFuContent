...
public class GTCEFuCHEUComponentLoader {
    ...
    public static void init() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(hStandard)
                .input(OrePrefix.frameGt, Materials.NaquadahAlloy, 2)
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(OrePrefix.foil, Materials.Silver, 10)
                .input(OrePrefix.stickLong, Materials.Invar, 2)
                .input(OrePrefix.bolt, Materials.HSSE, 8)
                .fluidInputs(Materials.TinAlloy.getFluid(576))
                .output(hConductive)
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(OrePrefix.wireFine, Materials.Tantalum, 8)
                .input(OrePrefix.foil, Materials.Invar, 6)
                .input(OrePrefix.screw, Materials.HSSE, 32)
                .fluidInputs(Materials.TinAlloy.getFluid(576))
                .output(eStandard)
                .duration(200).EUt(GTValues.VA[GTValues.LuV]).buildAndRegister();
